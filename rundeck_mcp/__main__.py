...
from .server_final import main_final as server_main_final
...
def serve(
    ...
    try:
        # Use the final working server implementation
        asyncio.run(server_main_final(enable_write_tools=enable_write_tools))
