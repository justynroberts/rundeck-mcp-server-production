...
def get_projects(server: Optional[str] = None) -> ListResponseModel[Project]:
    ...
    return ListResponseModel[Project](
        response=projects,
        total_count=len(projects)
    )


def get_project_stats(project: str, server: Optional[str] = None) -> ProjectStats:
