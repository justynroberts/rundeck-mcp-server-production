...
from ..models.rundeck import Job, JobDefinition, JobAnalysis, JobVisualization


def get_jobs(project: str, group: Optional[str] = None, server: Optional[str] = None) -> ListResponseModel[Job]:
    ...
    return ListResponseModel[Job](
        response=jobs,
        total_count=len(jobs)
    )


def get_job_definition(job_id: str, server: Optional[str] = None) -> JobDefinition:
...
def analyze_job(job_id: str, server: Optional[str] = None) -> JobAnalysis:
...
def visualize_job(job_id: str, server: Optional[str] = None) -> JobVisualization:
...
def enable_job(job_id: str, server: Optional[str] = None) -> Dict[str, Any]:
    """Enable a job.
...
def disable_job(job_id: str, server: Optional[str] = None) -> Dict[str, Any]:
    """Disable a job.
...
def enable_job_schedule(job_id: str, server: Optional[str] = None) -> Dict[str, Any]:
    """Enable job schedule.
...
def disable_job_schedule(job_id: str, server: Optional[str] = None) -> Dict[str, Any]:
