...
from ..models.rundeck import Server, SystemInfo, ExecutionMode
...
def list_servers() -> ListResponseModel[Server]:
    ...
    return ListResponseModel[Server](
        response=servers,
        total_count=len(servers)
    )


def get_system_info(server: Optional[str] = None) -> SystemInfo:
...
def get_execution_mode(server: Optional[str] = None) -> ExecutionMode:
...
def set_execution_mode(mode: str, server: Optional[str] = None) -> ExecutionMode:
    """Set execution mode.
