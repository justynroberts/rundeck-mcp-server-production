...
def get_nodes(project: str, filter_query: Optional[str] = None,
              tags: Optional[str] = None, server: Optional[str] = None) -> ListResponseModel[Node]:
    ...
    return ListResponseModel[Node](
        response=nodes,
        total_count=len(nodes)
    )


def get_node_details(project: str, node_name: str, server: Optional[str] = None) -> NodeDetails:
...
def get_node_summary(project: str, server: Optional[str] = None) -> NodeSummary:
