...
from rundeck_mcp.client import ClientManager, RundeckClient
...
class TestRundeckClient(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client = RundeckClient(base_url="https://test.rundeck.com", api_token="test-token", name="test-server")
